...
print('PAPER_API_KEY: ', PAPER_API_KEY, '\nPAPER_API_SECRET: ', PAPER_API_SECRET, '\nPAPER_APCA_API_BASE_URL: ', PAPER_APCA_API_BASE_URL)
...
print(clock)
print(date.datetime.now() - date.timedelta(hours=5))# - date.timedelta(minutes=1))
